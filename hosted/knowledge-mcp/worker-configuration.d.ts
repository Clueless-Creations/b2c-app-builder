/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf41c5061dfa37bf76b4ad4626b0eecd)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	DB: D1Database;
	INGRESS_LIMITER: RateLimit;
	AUTH_LIMITER: RateLimit;
	API_LIMITER: RateLimit;
	B2C_APP_BUILDER_PUBLIC_ORIGIN: "https://mcp.clueless-creations.com";
	B2C_APP_BUILDER_TRUSTED_REDIRECTS: ["https://chatgpt.com/connector_platform_oauth_redirect","https://claude.ai/api/mcp/auth_callback"];
	B2C_APP_BUILDER_ALLOWED_ORIGINS: ["https://chatgpt.com","https://claude.ai"];
	B2C_APP_BUILDER_AUTH_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "B2C_APP_BUILDER_PUBLIC_ORIGIN" | "B2C_APP_BUILDER_TRUSTED_REDIRECTS" | "B2C_APP_BUILDER_ALLOWED_ORIGINS" | "B2C_APP_BUILDER_AUTH_SECRET">> {}
}
