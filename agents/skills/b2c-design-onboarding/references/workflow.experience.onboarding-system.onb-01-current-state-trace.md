...
Canonical workflow: `workflow.experience.onboarding-system.onb-01-current-state-trace`. This is a reference contract, not an executable plan. Managed eligibility, ordering, authority, and acceptance remain with the installed business runtime.
...
Managed inputs: `product/onboarding/graph/ONB-00-resume-scope.md`

Consult when relevant: None declared.

Managed outputs: `product/onboarding/graph/ONB-01-current-state-trace.md`

## Verification and authority

Declared checks: `check:onboarding-evidence-onb-01`
