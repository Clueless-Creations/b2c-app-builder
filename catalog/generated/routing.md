...
| Load when | Reference |
| --- | --- |
| when DESIGN.md is created or revised, when a visual direction is drafted or reviewed, and when the Design Room needs the anti-generic review — derives palette/type/motion/imagery from strategy/RESEARCH.md audience facts and names the generic-template tells | [`knowledge/design/audience-derived-identity.md`](../../knowledge/design/audience-derived-identity.md) |
...
| when a Design Room mutation needs the mechanical worthiness floor or its independent audit must record the delegated taste decision before engineering harden, with no beauty score | [`knowledge/design/design-worthiness.md`](../../knowledge/design/design-worthiness.md) |
...
| before Expo or SwiftUI implementation when choosing recommended external agent skill packs for craft, motion, or store work, without vendor MCP lock-in | [`knowledge/engineering/recommended-agent-skills.md`](../../knowledge/engineering/recommended-agent-skills.md) |
