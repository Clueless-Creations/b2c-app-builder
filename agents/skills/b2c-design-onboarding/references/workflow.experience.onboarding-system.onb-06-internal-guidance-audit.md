...
Canonical workflow: `workflow.experience.onboarding-system.onb-06-internal-guidance-audit`. This is a reference contract, not an executable plan. Managed eligibility, ordering, authority, and acceptance remain with the installed business runtime.
...
Managed outputs: `product/onboarding/graph/ONB-06-internal-guidance-audit.md`

## Verification and authority

Declared checks: `check:onboarding-evidence-onb-06`
