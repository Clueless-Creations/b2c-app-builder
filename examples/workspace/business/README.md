...
- `state/`: canonical mutable launch state, trace, and evidence
- `strategy/`: market evidence, brand, portfolio, and tool decisions
- `PRODUCT.md`: authored product authority and route index
- `product/`: detailed onboarding, copy, and experience proof
