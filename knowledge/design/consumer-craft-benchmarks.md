...
Research date: 2026-09-12. The research inspected primary-source descriptions and public product imagery for the nine examples. It viewed grug screenshots in an Apple developer interview, official Airbnb release imagery, Duolingo's art-direction examples, and official screenshots or product images for Blippo+, Metaballs, Is This Seat Taken?, Hearing Buddy, and Structured. Quabble was added from its founder nomination and current first-party product/store descriptions; image-dependent runtime judgments remain unverified because no installed-app walkthrough was performed.
...
| Quabble            | The founder-selected reference describes a duck companion, a virtual park, daily routines, named activity objects such as Gratitude Jar, Worry Box, and Proud Dandelion, and a 15-day First Bloom journey. The official site and store listings provide product imagery and descriptions; no installed-app interaction or visual-runtime claim is made here. | Give an abstract daily practice a tangible object and a clear return rhythm. Let identity, progress, and the core task share one coherent world, while keeping the first action calm and legible. | A mascot, wellness park, gamified streak, therapeutic claim, or Quabble asset belongs in every product. A source description proves neither retention nor clinical efficacy. |

Primary sources: [Airbnb design system](https://medium.com/airbnb-design/building-a-visual-language-behind-the-scenes-of-our-airbnb-design-system-224748775e4e), [Airbnb release imagery](https://news.airbnb.com/product-releases/airbnb-2025-summer-release), [Duolingo art direction](https://blog.duolingo.com/shape-language-duolingos-art-style/), [Duolingo product principles](https://blog.duolingo.com/product-principles/), [grug developer interview](https://developer.apple.com/news/?id=ux44ymcr), [Blippo+](https://blippo.plus/), [Metaballs](https://www.apposite.ai/metaballs.html), [Is This Seat Taken? developer interview](https://developer.apple.com/news/?id=z12xq8fa), [Hearing Buddy](https://hearingbuddyapp.com/), [Structured](https://structured.app/), [Quabble official site](https://quabble.app/), [Quabble App Store listing](https://apps.apple.com/us/app/quabble-daily-mental-health/id6445948886), [Quabble Google Play listing](https://play.google.com/store/apps/details?id=com.museLIVE.quabbleapp).
