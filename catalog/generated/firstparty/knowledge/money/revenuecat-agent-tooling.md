...
| Catalog reconcile | `products\|entitlements\|offerings list`, `offerings packages <id>` | authenticated read, then authorized create | existing ids are preserved; create runs only with host authority and a typed offering id |
