...
Canonical workflow: `workflow.experience.onboarding-system.onb-10-first-value-activation`. This is a reference contract, not an executable plan. Managed eligibility, ordering, authority, and acceptance remain with the installed business runtime.
...
Managed outputs: `product/onboarding/graph/ONB-10-first-value-activation.md`

## Verification and authority

Declared checks: `check:onboarding-evidence-onb-10`
