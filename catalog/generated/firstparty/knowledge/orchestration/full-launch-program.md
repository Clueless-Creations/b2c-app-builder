...
5. Classify the start. A brownfield overhaul runs research in audit-and-gap-fill mode: keep, refresh, or redo each existing artifact with a dated reason. It does not silently restart.
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| 0 Orient                | `session-continuity-resume`, `orient-scaffold-and-state-cockpit-upkeep`, `founder-zero-operator-bootstrap`, `secrets-baseline-and-routing`, `paid-tool-routing-and-fallback`, `agent-operations-ledger`, `repository-profile-contract`                                                                                                                                                                                         | workspace register, spend ceiling, autonomy mode                                  |
| 1 Research to Go        | `research-backed-spec`, then `spec-red-team-audit` in a fresh context                                                                                                                                                                                                                                                                                                                                                          | Go, Pivot, or Kill. Kill or Pivot is success. No design or build spend before Go. |
