...
function operationSupport(): ExpoOperationSupport[] {
  return [
    ...
    },
    {
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "Typed argv through the existing execution kernel. No generic shell.",
    },
    {
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "iOS direct local needs macOS/Xcode. A Linux host cannot claim it ran Xcode.",
    },
    {
      id: "eas-local-build",
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "Not identical to direct local compile. Still has auth/project-check behavior.",
    },
    {
      id: "eas-cloud-build",
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "Paid/remote effect. Separate from Expo framework selection.",
    },
    {
      id: "eas-workflows",
      title: "EAS Workflows",
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "Must not become a second business orchestrator or auto-submit.",
    },
    {
      id: "store-handoff",
      ...
      evidenceTier: "blocked",
      queuedIssue: 84,
      notes: "Existing ASC/Play owners remain authoritative.",
    },
    {
      id: "eas-update",
      title: "EAS Update",
