...
| before Expo or SwiftUI implementation when choosing recommended external agent skill packs for craft, motion, store work, or optional design-research provider guidance without vendor lock-in | [`knowledge/engineering/recommended-agent-skills.md`](../../knowledge/engineering/recommended-agent-skills.md) |
